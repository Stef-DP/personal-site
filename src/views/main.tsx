...
export default function Main() {
	...
	const [page, setPage] = useState<PageType>(pages.includes(pageQuery as PageType)
		? (pageQuery as PageType) || "home"
		: "home"
	);
	...
	useEffect(() => {
		setPage((prevPage) =>
			pages.includes(pageQuery as PageType)
				? (pageQuery as PageType) || prevPage
				: pageQuery === ""
					? "home"
					: prevPage,
		);
